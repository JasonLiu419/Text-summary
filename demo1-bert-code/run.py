...
path0 = input('please give the directory of the target article:')
num0 = input('please give the number of the sentences you want in the abstract:')
num0 = int(num0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--extract_num', type=int, default=num0, help='number of extracted sentences')
    ...
    parser.add_argument('--test_data_file', type=str, help='data for testing', default=path0)
